					...
					<center>
						...
						<div class="mui-container">
							<h3 class="mui--text-center">
								<img style="max-width: 10rem;" src="http://hack.ehb.be/assets/img/logoV3.png"
									 alt="ehackb logo">
							</h3>
									...
									<td class="mui-panel">
										...
										>
											<tbody>
												<tr>
													<td>
														<h2>Welkom op EHACKB!</h2>
													</td>
												</tr>
												<tr>
													<td class="mui--divider-top">
														Hallo {{ $registration->fname }},
													</td>
												</tr>
												<tr>
													<td>
